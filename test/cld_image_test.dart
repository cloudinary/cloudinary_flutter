...
void main() {
  ...
  testWidgets('Test CldImageWidget with version has valid url',
    ...
    final imageFinder = find.image(
        CachedNetworkImageProvider('https://res.cloudinary.com/demo/image/upload/v1/sample'));
    expect(imageFinder, findsOneWidget);
  });
  ...
  testWidgets('Test CldImageWidget with version and urlsuffix has valid url',
    ...
    final imageFinder = find.image(
        CachedNetworkImageProvider('https://res.cloudinary.com/demo/images/v1/sample/test'));
    expect(imageFinder, findsOneWidget);
  });
