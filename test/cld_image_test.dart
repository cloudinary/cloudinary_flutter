...
void main() {
  ...
  testWidgets('Test CldImageWidget has valid url with analytics',
      (widgetTester) async {
    cloudinary.analytics = Analytics.fromParameters(sdk: 'O', version: '1.0.0', techVersion: '39.1', osType: 'Z', osVersion: '0');
    ...
    final imageFinder = find.image(CachedNetworkImageProvider(
        'https://res.cloudinary.com/demo/image/upload/dog?_a=DAOAABCLZAA0'));
    expect(imageFinder, findsOneWidget);
  });
}